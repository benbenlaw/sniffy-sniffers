...
public class SniffySnifferModel extends EntityModel<SniffySnifferRenderState> {
    ...
    public SniffySnifferModel(ModelPart root) {
        super(root);
    ...
    public void setupAnim(SniffySnifferRenderState state) {
